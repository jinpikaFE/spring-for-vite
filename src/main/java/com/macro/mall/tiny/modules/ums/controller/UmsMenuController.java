...
public class UmsMenuController {
    ...
    @ResponseBody
    public ResponseEntity<CommonResult<Object>> create(@RequestBody UmsMenu umsMenu) {
    ...
    @ResponseBody
    public ResponseEntity<CommonResult<UmsMenu>> getItem(@PathVariable Long id) {
    ...
    @ResponseBody
    public ResponseEntity<CommonResult<CommonPage<UmsMenu>>> list(@PathVariable Long parentId,
    ...
    @ResponseBody
    public ResponseEntity<CommonResult<List<UmsMenuNode>>> treeList() {
